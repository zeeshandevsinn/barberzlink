class AppStrings {
  static const String welcomeMessage = "Welcome to Barberz Link";
  static const String searchHint = "Search for barbers, jobs, or schools";
  static const String registrationPrompt = "Join the Barberz Link community";
  static const String onboardingSubtitle = "Connect, Hire, Grow.";
  static const String getStartedButton = "Get Started";
  static const String eventImage = "assets/images/events.jpg";
  static const String schoolImage = "assets/images/schools.jpg";
  ...
  static const String businessTipsDescription =
      "Business Resources connects barbers and barbershop owners with trusted companies and professional resources designed to help them grow and secure their financial future. This section provides guidance on business startups, tax information, financial planning, investments, 401(k) options, insurance solutions, banking services, and expert business support—giving every barber the tools and knowledge needed to build, manage, and protect a successful career or shop.";
}
